...
export class BusinessName extends BaseForm {
  ...
  checkFormValidity() {
    ...
    console.log("VALID BUSINESSNAME FORM C", formData);
    ...
    const validBusinessNameInput = validateName(
      this.state.form.proposedBusinessName || ""
    );
    if (!validBusinessNameInput) {
      // flashMessage(APP_NAME, "Business name cannot be a word", BLOCKER);
          ...
          >
            ...
            <FormInput
              ...
              onChangeText={(proposedBusinessName, isValid) => {
                ...
                this.checkNameValidity(proposedBusinessName);
                this.checkFormValidity();
              }}
              onSubmitEditing={() => {
                this.checkFormValidity();
