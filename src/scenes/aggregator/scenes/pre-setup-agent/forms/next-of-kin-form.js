...
export default class PreSetupAgentForm extends BaseForm {
  ...
  componentDidMount() {
    const nextOfKin = this.props.application.nextOfKin || this.props.application?.applicantDetails?.nextOfKin || {}
      ...
      <React.Fragment>
        ...
        <FormPhone
          ...
          onChangeText={(phoneNumber) => {
            ...
            this.props.evaluateInvalidField({ phoneNumber }, MIN_NIGERIA_PHONE_LENGTH)
          }}
          outerContainerStyle={styles.formInputOuterContainerStyle}
          placeholder="***********"
