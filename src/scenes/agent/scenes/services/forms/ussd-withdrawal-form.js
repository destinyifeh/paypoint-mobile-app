      ...
      <React.Fragment>
        ...
        <FormInput
          ...
          onChangeText={(pin, isValid) => {
            this.props.updateFormField({ pin });
            !isValid
        ...
        <FormCheckbox
          ...
          onSelect={(gender, isValid) => {
            this.props.updateFormField({ gender });
            isValid === false
...
class USSDWithdrawalForm_ extends BaseForm {
  constructor() {
    ...
    this.requiredFields = ["phone", "bankCode", "amount"];
        ...
        <React.Fragment>
          ...
          <FormPicker
            ...
            onSelect={(bankCode, isValid) => {
              this.props.updateFormField({
                bankCode,
                bankName: banks.find((bank) => bankCode === bank.cbnCode)?.name,
              });
              isValid === false
