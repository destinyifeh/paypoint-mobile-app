...
import { MIN_NAME_LENGTH, MIN_NIGERIA_PHONE_LENGTH, MIN_ADDRESS_LENGTH } from '../../../../../constants/fields';
...
export class NextOfKinInformation extends BaseForm {
  requiredFields = [
    'firstName',
    'lastName',
    'phone',
  ...
  componentDidMount() {
    ...
    const nextOfKinDetails = applicantDetails ? (applicantDetails.nextOfKin || {} ) : {};
