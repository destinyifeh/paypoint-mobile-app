...
import { APP_NAME, EXPIRED_SESSION_MESSAGE, USER } from '../../constants';
...
class MainScene extends React.Component {
  ...
  render() {
    ...
    const routes = {
      ...
      'AggregatorPresetupAgent': <PreSetupAgentScene
        withNavigator 
      />,
    ...
    return enable_fip === false 
      ? <DisabledScene sceneName="Aggregator features" includeLogoutButton includeStatusBar /> 
      : <View style={{
        height: '100%',
        position: 'absolute',
        width: '100%'
