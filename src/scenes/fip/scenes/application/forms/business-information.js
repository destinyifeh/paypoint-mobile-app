...
export class BusinessInformation extends BaseForm {
  ...
  componentDidMount() {
    const { applicantDetails, agentTypeId } = this.props.application;
    ...
    const businessName =
      agentTypeId !== 3
        ...
        : serializedBusinessDetails.businessName || null;
    const isSuperAgent = agentTypeId === 3;
...
export class Attachments extends BaseForm {
  ...
  requiredFiles = ["Utility Bill", "Guarantor's Form"];
  ...
  componentDidMount() {
    ...
    const businessInformationAttachments = this.serializeApiData(
  ...
  render() {
    ...
    const hiddenAttachments = ["ID Card", "Passport Photo"];
    ...
    return (
      <React.Fragment>
        ...
        <Hyperlink
          ...
          onPress={() =>
            Linking.openURL(
              `${CDN_BASE_URL}/p/finch-agent-dashboard/documents/CHARACTER CONFIRMATION FORM.pdf`
            )
          }
        >
          Download Character Attestation Form
        </Hyperlink>
