...
class UnderlayNavigator extends React.Component {
  ...
  persistenceKey = 'aggregatorMainScenePersistenceKey';
  scenes = {
  ...
  onLandingAgentButtonPress() {
    this.props.resetApplication();

    this.props.navigateTo('Landing');
        ...
        <View
          ...
          <View
            ...
            <Button
              ...
              icon={
                <Icon
                  ...
                  color={`rgba(255, 255, 255, ${
                    this.state.active === 'landing' ? 1 : 0.6
                  })`}
                />
              }
              title="Landing"
              titleStyle={{
                fontWeight: 'bold',
                opacity: this.state.active === 'landing' ? 1 : 0.6,
                textTransform: null,
              }}
              transparent
              onPress={this.onLandingAgentButtonPress}
            />
